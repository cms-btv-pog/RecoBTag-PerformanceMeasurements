...
# data from /BTag/Run2012A-PromptReco-v1/AOD
       ...
       'file:/opt/sbg/data/data2/cms/cbeluffi/Btag/Btag_2012_11_13/CMSSW_5_3_2/src/RecoBTag/PerformanceMeasurements/test/02CFCC4D-68EB-E111-A8A8-485B39800C2B.root'
  )
)
