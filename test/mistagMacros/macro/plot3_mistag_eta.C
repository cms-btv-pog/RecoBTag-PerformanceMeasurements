plot()
{
 TFile *f1 = new TFile("../output/QCDall_JPm.root");
...
// Initialise Histograms
 ...
 TF1 *fun = new TF1("fun","[0]+[1]*x+[2]*x*x",0.,2.4); // Loose Medium
//$$ TF1 *fun = new TF1("fun","([0]+[1]*x)/(1.+[2]*x*x)",0.,2.4); // Tight
 TF1 *gun = new TF1("gun","[0]",80.,120.);
 TF1 *hun = new TF1("hun","[0]",40.,230.);
//  TF1 *hun = new TF1("hun","[0]+[1]*x*x+[2]*x*x*x",0.,2.4);
      hun->SetLineColor(1);

       f1->cd();
 TH1F* g00 = (TH1F*)gROOT->FindObject("hAllFlav_JetEta");   // all
 TH1F* g01 = (TH1F*)gROOT->FindObject("hUDSFlav_JetEta");   // uds-jet
 TH1F* g02 = (TH1F*)gROOT->FindObject("hCFlav_JetEta");     // c-jet
 TH1F* g03 = (TH1F*)gROOT->FindObject("hBFlav_JetEta");     // b-jet
 TH1F* g04 = (TH1F*)gROOT->FindObject("hGluonFlav_JetEta"); // g-jet
 TH1F* g09 = (TH1F*)gROOT->FindObject("hLightFlav_JetEta"); // udsg-jet
//
 TH1F* g10 = (TH1F*)gROOT->FindObject("hAllFlav_NegTag_JetEta");   // all neg
 TH1F* g19 = (TH1F*)gROOT->FindObject("hLightFlav_NegTag_JetEta"); // udsg neg 
//
 TH1F* h00 = (TH1F*)gROOT->FindObject("hAllFlav_Veto_JetEta");   // all with veto
 TH1F* h01 = (TH1F*)gROOT->FindObject("hUDSFlav_Veto_JetEta");   // uds-jet with veto 
 TH1F* h02 = (TH1F*)gROOT->FindObject("hCFlav_Veto_JetEta");     // c-jet with veto 
 TH1F* h03 = (TH1F*)gROOT->FindObject("hBFlav_Veto_JetEta");     // b-jet with veto
 TH1F* h04 = (TH1F*)gROOT->FindObject("hGluonFlav_Veto_JetEta"); // g-jet with veto
 TH1F* h09 = (TH1F*)gROOT->FindObject("hLightFlav_Veto_JetEta"); // udsg-jet with veto 
//
 TH1F* h10 = (TH1F*)gROOT->FindObject("hAllFlav_Veto_NegTag_JetEta");   // all neg with veto
 TH1F* h11 = (TH1F*)gROOT->FindObject("hUDSFlav_Veto_NegTag_JetEta");   // uds neg with veto 
 TH1F* h12 = (TH1F*)gROOT->FindObject("hCFlav_Veto_NegTag_JetEta");     // c neg with veto
 TH1F* h13 = (TH1F*)gROOT->FindObject("hBFlav_Veto_NegTag_JetEta");     // b neg with veto
 TH1F* h14 = (TH1F*)gROOT->FindObject("hGluonFlav_Veto_NegTag_JetEta"); // g neg with veto
//
 TH1F* h20 = (TH1F*)gROOT->FindObject("hAllFlav_PosTag_JetEta");   // all pos
...
//
 ...
 TH1F* h110 = (TH1F*)gROOT->FindObject("hAllFlav_K0s_Veto_NegTag_JetEta");
...
//
 ...
 TH1F* h210 = (TH1F*)gROOT->FindObject("hAllFlav_Fak_Veto_NegTag_JetEta");
...
//
 ...
 TH1F* h310 = (TH1F*)gROOT->FindObject("hAllFlav_Gam_Veto_NegTag_JetEta");
...
//$$
 TH1F* h4= new TH1F("h4","",24,0.,2.4);  // light pos / light
//  TH1F* h4= new TH1F("h4","Track Count Tight : no veto",24,0.,2.4);  // light pos / light
//  TH1F* h4= new TH1F("h4","Jet Proba pos Medium : no veto",24,0.,2.4);  // light pos / light
//  TH1F* h4= new TH1F("h4","Jet Proba all Medium : no veto",24,0.,2.4);  // light pos / light
//  TH1F* h4= new TH1F("h4","Second Vertex Medium : no veto",24,0.,2.4);  // light pos / light
       h4->Divide(h29,g09,1,1,"B"); 
//$$
 TH1F* h5= new TH1F("h5","",24,0.,2.4);  // all neg with veto / all with veto
       h5->Divide(h10,h00,1,1,"B");

//  TH1F* h6= new TH1F("h6","Rl  =  mistag / neg.tag",24,0.,2.4);  // (light pos/light) / (all neg/all)
 TH1F* h6= new TH1F("h6","",24,0.,2.4);  // (light pos/light) / (all neg/all)
       h6->Divide(h4,h5,1,1);

 TH1F* h8= new TH1F("h8","",24,0.,2.4);  // uds pos / uds
       h8->Divide(h21,g01,1,1,"B");

 TH1F* h9= new TH1F("h9","",24,0.,2.4);  // g pos / g
...
//$$       
       ...
       h4->GetXaxis()->SetTitle("|#eta(jet)|");
       h4->GetXaxis()->SetTitleColor(1);
//        h4->SetMinimum(0.01); h4->SetMaximum(1.00); // Loose
       h4->SetMinimum(0.001); h4->SetMaximum(0.20); // Medium
//        h4->SetMinimum(0.00001); h4->SetMaximum(0.10); // Tight
...
// Flavour fraction
 ...
 TH1F* k00= new TH1F("k00","",24,0.,2.4);  // g/uds ratio
 TH1F* k01= new TH1F("k01","",24,0.,2.4);  // uds-fraction
 TH1F* k02= new TH1F("k02","",24,0.,2.4);  // c-fraction
 TH1F* k03= new TH1F("k03","",24,0.,2.4);  // b-fraction
 TH1F* k04= new TH1F("k04","flavour fraction",24,0.,2.4);  // g-fraction
 TH1F* k11= new TH1F("k11","",24,0.,2.4);  // uds-fraction neg
 TH1F* k12= new TH1F("k12","flavour fraction",24,0.,2.4);  // c-fraction neg
 TH1F* k13= new TH1F("k13","",24,0.,2.4);  // b-fraction neg
 TH1F* k14= new TH1F("k14","",24,0.,2.4);  // g-fraction neg
 TH1F* k21= new TH1F("k21","",24,0.,2.4);  // uds-fraction pos
 TH1F* k24= new TH1F("k24","",24,0.,2.4);  // g-fraction pos
...
// systematics due to sign flip
 ...
 TH1F* h1= new TH1F("h1","",24,0.,2.4); // all pos / all neg
       h1->Divide(h20,g10,1,1);
 TH1F* h2= new TH1F("h2","",24,0.,2.4); // light neg / light pos
       h2->Divide(g19,h29,1,1);
 TH1F* sf= new TH1F("sf","",24,0.,2.4); // sign flip
       sf->Add(h1,h2,Xip,-Xip);

// systematics due to V0

 TH1F* h71= new TH1F("h71","",24,0.,2.4); // K0 neg / all neg
       h71->Divide(h110,h10,1,1,"B");
 TH1F* h72= new TH1F("h72","",24,0.,2.4); // light K0 pos / light pos
       h72->Divide(h129,h29,1,1,"B");
 TH1F* h73= new TH1F("h73","",24,0.,2.4); // light K0 / light
       h73->Divide(h109,h09,1,1,"B");
 TH1F* h74= new TH1F("h74","",24,0.,2.4); // K0 / all
       h74->Divide(h100,h00,1,1,"B");

 TH1F* h81= new TH1F("h81","",24,0.,2.4); // Bad neg / all neg
       h81->Divide(h210,h10,SFbad,1,"B");
 TH1F* h82= new TH1F("h82","",24,0.,2.4); // light Bad pos / light pos
       h82->Divide(h229,h29,SFbad,1,"B");
 TH1F* h83= new TH1F("h83","",24,0.,2.4); // light Bad / light
       h83->Divide(h209,h09,SFbad,1,"B");
 TH1F* h84= new TH1F("h84","",24,0.,2.4); // Bad / all
       h84->Divide(h200,h00,SFbad,1,"B");

 TH1F* h91= new TH1F("h91","",24,0.,2.4); // gamma neg / all neg
       h91->Divide(h310,h10,1,1,"B");
 TH1F* h92= new TH1F("h92","",24,0.,2.4); // light gamma pos / light pos
       h92->Divide(h329,h29,1,1,"B");
 TH1F* h93= new TH1F("h93","",24,0.,2.4); // light gamma / light
       h93->Divide(h309,h09,1,1,"B");
 TH1F* h94= new TH1F("h94","",24,0.,2.4); // gamma / all
       h94->Divide(h300,h00,1,1,"B");

 TH1F* ka = new TH1F("ka","",24,0.,2.4);
 TH1F* bad = new TH1F("bad","",24,0.,2.4);
 TH1F* ga = new TH1F("ga","",24,0.,2.4);
 TH1F* v0 = new TH1F("v0","",24,0.,2.4);
...
// cout << "############################################################" << endl; 
// cout << "############################################################" << endl; 
//  TH1F* tot= new TH1F("tot","Systematics",24,0.,2.4);
 TH1F* tot= new TH1F("tot","",24,0.,2.4);
       for (int i=0; i<30; i++) {
...
// Rlight
 ...
 TF1 *fun = new TF1("fun","[0]+[1]*x+[2]*x*x",0.,2.4);
      fun->SetLineColor(1);
      fun->SetLineStyle(1);
 TF1 *gun = new TF1("gun","[0]+[1]*x+[2]*x*x",0.,2.4);
      gun->SetLineColor(1);
      gun->SetLineStyle(2);
 TF1 *hun = new TF1("hun","[0]+[1]*x+[2]*x*x",0.,2.4);
      hun->SetLineColor(1);
      hun->SetLineStyle(2);

 TH1F* u6= new TH1F("u6","",24,0.,2.4);
 TH1F* d6= new TH1F("u6","",24,0.,2.4);
       for (int i=0; i<30; i++) {
	...
	float yd = y - TMath::Sqrt( ey*ey + syst*syst*y*y );
     ...
     pad3->cd();
       ...
       d6->Fit("hun","rvee0");
       hun->Draw("same"); 
       h6->SetMinimum(0.); h6->SetMaximum(2.0); // Loose or Medium
//        h6->SetMinimum(0.); h6->SetMaximum(4.0); // Medium or Tight NOveto 
//        h6->SetMinimum(0.); h6->SetMaximum(6.0); // Tight 
//        h6->SetMinimum(0.5); h6->SetMaximum(3.5);
...
//  TH1F* h89= new TH1F("h89","",24,0.,2.4);  // uds tag / g tag
...
// Final Histograms
  ...
  TH1F* hMistag_JetEta     = new TH1F("hMistag_JetEta","eta(jet)",24,0.,2.4);
  TH1F* hNegTag_JetEta     = new TH1F("hNegTag_JetEta","eta(jet)",24,0.,2.4);
  TH1F* hRlight_JetEta     = new TH1F("hRlight_JetEta","eta(jet)",24,0.,2.4);
  TH1F* hRlightSyst_JetEta = new TH1F("hRlightSyst_JetEta","eta(jet)",24,0.,2.4);

  hMistag_JetEta -> Add(h4,h4,1,0);
  hNegTag_JetEta -> Add(h5,h5,1,0);
  hRlight_JetEta -> Add(h6,h6,1,0);
  hRlightSyst_JetEta -> Add(tot,tot,1,0);
