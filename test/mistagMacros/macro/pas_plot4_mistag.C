...
{
// DATA
 TFile *f0 = new TFile("../output/Data_TCHEL.root");
// Primary MC sample
 TFile *f1 = new TFile("../output/MC_QCD-Pt153080_TCHEL.root");
// MC with Track History
 TFile *f2 = new TFile("../output/MC_QCD-Pt153080_TCHEL.root");
...
//        Mistag->SetMinimum(0.0); Mistag->SetMaximum(0.006); // tight
       Mistag->SetTitleFont(42, "XYZ");
       Mistag->GetXaxis()->SetTitle(xtitle);
       Mistag->GetYaxis()->SetTitle("mistag rate");
       Mistag->GetYaxis()->SetTitleOffset(1.4);
       Mistag->SetTickLength(0.03, "XYZ");
       Mistag->SetLabelOffset(0.007,"XYZ");
       Mistag->SetLabelSize(0.07, "XYZ");
       Mistag->SetLabelFont(42, "XYZ");
       Mistag->SetTitleSize(0.07, "XYZ");
       Mistag->SetNdivisions(509,"XYZ");
       Mistag->Draw("Esame"); 
       Mistag->Fit("Fun","rvee"); 
       Mistag->Draw("Esame"); 
       Fun->Draw("same"); 
  ...
  TText *text = abc->AddText("TCHEL tagger");   
...
//  TF1 *HUn = new TF1("HUn","([0]+[1]*x)/(1+[2]*x)",bini,bini+nbin*binw);
 ...
 TH1F* SFmin= new TH1F("SFmin","",nbin,bini,bini+nbin*binw);  // SF down
     ...
     pad2->cd();
       ...
       SFlight->SetTitleFont(42, "XYZ");
       SFlight->GetXaxis()->SetTitle(xtitle);
       SFlight->GetYaxis()->SetTitle("Data/MC");
       SFlight->GetYaxis()->SetTitleOffset(1.1);
       SFlight->SetTickLength(0.03, "XYZ");
       SFlight->SetLabelOffset(0.007,"XYZ");
       SFlight->SetLabelSize(0.07, "XYZ");
       SFlight->SetLabelFont(42, "XYZ");
       SFlight->SetTitleSize(0.07, "XYZ");
       SFlight->SetNdivisions(509,"XYZ");
       SFlight->Draw("Esame"); 
