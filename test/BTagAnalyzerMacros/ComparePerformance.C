...
void DrawEffvsPt(TString name, bool log, TString titlename, int icase1){
    ...
    qw->AddEntry(Eff1_b, "13TeV 20PU25ns Phys14", "l");
    qw->AddEntry(Eff2_b, "13TeV 20PU25ns CSA14", "l");
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")) qw->AddEntry(Eff3_b, "8TeV nPUtrue17-23 53X", "l");
    TLegend* qw2 = 0;
    ...
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")) qw2->AddEntry(Eff3_b, "8TeV nPUtrue17-23 53X", "l");
    ...
    Eff1_b->Draw();
    Eff2_b->Draw("same");
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")) Eff3_b->Draw("same");
    latex->DrawLatex(0.1, 0.94, titlename);
    qw->Draw();
    ...
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")  and Eff1_c->GetMinimum()> Eff3_c->GetMinimum()) Eff1_c->SetMinimum(Eff3_c->GetMinimum()*0.5) ;
    Eff1_c->Draw();
    Eff2_c->Draw("same");
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")) Eff3_c->Draw("same");
    latex->DrawLatex(0.1, 0.94, titlename);
    qw2->Draw();
    ...
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")  and Eff1_l->GetMinimum()> Eff3_l->GetMinimum()) Eff1_l->SetMinimum(Eff3_l->GetMinimum()*0.5) ;
    Eff1_l->Draw();
    Eff2_l->Draw("same");
    if (use8TeV and (name != "CSVIVF" && name != "CSVIVF_1" && name != "CSVIVF_2" && name != "csvivfl" && name != "csvivfm")) Eff3_l->Draw("same");
    latex->DrawLatex(0.1, 0.94, titlename);
    qw2->Draw();
...
//        if (*iter == "CSVIVF" && use8TeV) continue;
//        if (*iter == "CSVIVF_1" && use8TeV) continue;
//        if (*iter == "CSVIVF_2" && use8TeV) continue;
