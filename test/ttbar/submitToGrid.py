...
def submitProduction(tag,lfnDirBase,dataset,isData,cfg,workDir,lumiMask,submit=False):
    ...
    config_file.write('config.JobType.pyCfgParams = [\'useTTbarFilter=True\', \'miniAOD=True\', \'usePFchs=True\', \'maxEvents=-1\', \'runOnData=%r\']\n' % isData)    
    config_file.write('\n')
...
def main():
    ...
    parser.add_option('-l', '--lumi',        dest='lumiMask',    help='json with list of good lumis', default='/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/Cert_246908-251252_13TeV_PromptReco_Collisions15_JSON.txt',    type='string')
