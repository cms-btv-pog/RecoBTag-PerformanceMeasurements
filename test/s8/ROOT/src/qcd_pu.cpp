...
void scale(TFile *file, TH1 *hist)
{
    ...
    {
        hist->Scale(579200000 * 0.00254 / 2435660 * luminosity);
    }
    else if ("pt20to30" == filename)
    {
        hist->Scale(236300000 * 0.00518 / 9381624 * luminosity);
    }
    else if ("pt30to50" == filename)
    {
        hist->Scale(53070000 * 0.01090 / 9154953 * luminosity);
    }
    else if ("pt50to80" == filename)
    {
        hist->Scale(6351000 * 0.02274 / 8719642 * luminosity);
    }
    else if ("pt80to120" == filename)
    {
        hist->Scale(785100 * 0.037 / 2658714 * luminosity);
    }
    else if ("pt120to150" == filename)
    {
        hist->Scale(92950 * 0.04777 / 770186 * luminosity);
    }
    else if ("pt150" == filename)
    {
        hist->Scale(47580 * 0.05964 / 796237 * luminosity);
    }
