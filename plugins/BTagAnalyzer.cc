					  ...
					  const edm::Event& iEvent, const edm::EventSetup& iSetup, const int iJetColl)
{
  ...
  for ( PatJetCollection::const_iterator pjet = jetsColl->begin(); pjet != jetsColl->end(); ++pjet ) {
    ...
    if ( storeCSVTagVariables )
    {
      ...
      JetInfo[iJetColl].TagVarCSV_flightDistance1dAbsVal[JetInfo[iJetColl].nJet]      = ( vars.checkTag(reco::btau::flightDistance1dVal) ? fabs(vars.get(reco::btau::flightDistance1dVal)) : -9999 );
      JetInfo[iJetColl].TagVarCSV_flightDistance1dAbsSig[JetInfo[iJetColl].nJet]      = ( vars.checkTag(reco::btau::flightDistance1dSig) ? fabs(vars.get(reco::btau::flightDistance1dSig)) : -9999 );
      JetInfo[iJetColl].TagVarCSV_flightDistance2dAbsVal[JetInfo[iJetColl].nJet]      = ( vars.checkTag(reco::btau::flightDistance2dVal) ? fabs(vars.get(reco::btau::flightDistance2dVal)) : -9999 );
      JetInfo[iJetColl].TagVarCSV_flightDistance2dAbsSig[JetInfo[iJetColl].nJet]      = ( vars.checkTag(reco::btau::flightDistance2dSig) ? fabs(vars.get(reco::btau::flightDistance2dSig)) : -9999 );
      JetInfo[iJetColl].TagVarCSV_flightDistance3dAbsVal[JetInfo[iJetColl].nJet]      = ( vars.checkTag(reco::btau::flightDistance3dVal) ? fabs(vars.get(reco::btau::flightDistance3dVal)) : -9999 );
      JetInfo[iJetColl].TagVarCSV_flightDistance3dAbsSig[JetInfo[iJetColl].nJet]      = ( vars.checkTag(reco::btau::flightDistance3dSig) ? fabs(vars.get(reco::btau::flightDistance3dSig)) : -9999 );
      ...
      tagValList = vars.getList(reco::btau::trackIp1dVal,false);
