...
class JetInfoBranches {
  ...
  public :
    ...
    float Jet_DeepDoubleX[nMaxJets_];
	...
	if(variableParser.isToBeStored(name+"DeepBoostedJetInput_sv_costhetasvpv")) tree->Branch((name+"DeepBoostedJetInput_sv_costhetasvpv").c_str()	, DeepBoostedJetInput_sv_costhetasvpv, (name+"DeepBoostedJetInput_sv_costhetasvpv["+name+"nSVDeepBoostedJet]/F").c_str());
      ...
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleX")) tree->Branch((name+"Jet_DeepDoubleX").c_str(),      Jet_DeepDoubleX      ,(name+"Jet_DeepDoubleX["+name+"nJet]/F").c_str());
    ...
    void ReadBranches(TTree *tree, VariableParser variableParser, std::string name="") {
      ...
      if(variableParser.isToBeStored(name+"Jet_DeepDoubleX")) tree->SetBranchAddress((name+"Jet_DeepDoubleX").c_str(),      Jet_DeepDoubleX      );
