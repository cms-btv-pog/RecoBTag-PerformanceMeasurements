...
class JetInfoBranches {
  ...
  public :
    ...
    //FormultipleCSVv2
    float Jet_CombIVFNew[nMaxJets_];
    ...
    void RegisterTree(TTree *tree, std::string name="") {
      ...
      tree->Branch((name+"Jet_isPU").c_str(),        Jet_isPU        ,(name+"Jet_isPU["+name+"nJet]/I").c_str());
      ...
      //FormultipleCSVv2
      tree->Branch((name+"Jet_CombIVFNew").c_str(),     Jet_CombIVFNew     ,(name+"Jet_CombIVFNew["+name+"nJet]/F").c_str());
    ...
    void ReadTree(TTree *tree, std::string name="") {
      ...
      tree->SetBranchAddress((name+"Jet_isPU").c_str(),        Jet_isPU     );
      ...
      //FormultipleCSVv2
      tree->SetBranchAddress((name+"Jet_CombIVFNew").c_str(),     Jet_CombIVFNew     );
