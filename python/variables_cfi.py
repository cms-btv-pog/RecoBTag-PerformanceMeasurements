...
variableList = [
    ...
    cms.PSet(
      variable    = cms.string("nTrkDeepDoubleB"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("nTrkDeepDoubleB"),
      requires    = cms.vstring(),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("Jet_DeepDoubleB_nFirstTrkTagVar"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_DeepDoubleB_nFirstTrkTagVar"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("Jet_DeepDoubleB_nLastTrkTagVar"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_DeepDoubleB_nLastTrkTagVar"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_EtaRel"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_EtaRel"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_PtRatio"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_PtRatio"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_PParRatio"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_PParRatio"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_Sip2dVal"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_Sip2dVal"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_Sip2dSig"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_Sip2dSig"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_Sip3dVal"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_Sip3dVal"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_Sip3dSig"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_Sip3dSig"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_charged_JetDistVal"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_charged_JetDistVal"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("nSVDeepDoubleB"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("nSVDeepDoubleB"),
      requires    = cms.vstring(),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("Jet_DeepDoubleB_nFirstSVTagVar"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_DeepDoubleB_nFirstSVTagVar"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("Jet_DeepDoubleB_nLastSVTagVar"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_DeepDoubleB_nLastSVTagVar"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_sv_d3d"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_sv_d3d"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
      variable    = cms.string("DeepDoubleBInput_sv_d3dsig"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("DeepDoubleBInput_sv_d3dsig"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring("runDeepDoubleBTagVariables"),
    ),
    cms.PSet(
