...
# with command line options: step3 --conditions auto:phase1_2021_realistic -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT --datatier GEN-SIM-RECO,MINIAODSIM -n 1 --geometry DB:Extended --era Run3 --eventcontent RECOSIM,MINIAODSIM --filein file:step2_DIGI_L1_DIGI2RAW_HLT.root
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_RECOSIM_EI_PAT.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_RECOSIM_EI_PAT_inMINIAODSIM.root'),
